...
all: lib obj bin lib/libdtorr.so bin/test_bencoding bin/test_metadata bin/test_uri
...
lib/libdtorr.so: obj/log.o obj/hashmap.o obj/metadata.o obj/dtorr.o obj/bencoding_decode.o \
	obj/bencoding_encode.o obj/uri.o
	gcc -shared -o ./lib/libdtorr.so obj/log.o obj/hashmap.o obj/metadata.o obj/dtorr.o obj/uri.o \
